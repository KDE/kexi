...
Name[zh_CN]=Kexi
Type=Application
Exec=kexi-@KEXI_DISTRIBUTION_VERSION@ %f
Icon=kexi-@KEXI_DISTRIBUTION_VERSION@
...
GenericName[ca@valencia]=Constructor visual d'aplicacions de bases de dades
GenericName[de]=Visuelle Erstellung von Datenbankanwendungen
GenericName[en_GB]=Visual database apps builder
GenericName[es]=Constructor visual de aplicaciones de bases de datos
GenericName[fi]=Visuaalinen tietokantasovellusten luonti
GenericName[fr]=Constructeur d'applications de bases de données visuel
GenericName[gl]=Construtor visual de aplicativos de base de datos
GenericName[it]=Generatore visuale di applicazioni di banche dati
...
GenericName[sk]=Vizuálny tvorca databázových aplikácií
...
GenericName[zh_CN]=可视化数据库应用程序生成器
Comment=Visually develop database applications
Comment[ca]=Desenvolupament visual d'aplicacions de bases de dades
Comment[ca@valencia]=Desenvolupament visual d'aplicacions de bases de dades
Comment[cs]=Vyvíjejte vizuálně databázové aplikace
Comment[de]=Visuelle Entwicklung von Datenbankanwendungen
Comment[en_GB]=Visually develop database applications
Comment[es]=Desarrollo visual de aplicaciones de bases de datos
Comment[fi]=Kehitä tietokantasovelluksia visuaalisesti
Comment[fr]=Développer visuellement des applications de bases de données
Comment[gl]=Desenvolva visualmente aplicativos de base de datos.
Comment[it]=Sviluppa applicazioni per banche dati in modo visuale
...
Comment[sk]=Vizuálny vývoj databázových aplikácií
...
Comment[zh_CN]=可视化开发数据库应用程序
X-DocPath=kexi-@KEXI_DISTRIBUTION_VERSION@/index.html
X-KDE-NativeMimeType=application/x-kexiproject-sqlite
Categories=Qt;KDE;Office;Database;Development;
