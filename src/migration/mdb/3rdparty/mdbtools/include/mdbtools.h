...
extern LIBMDB_DLL void *read_pg_if_n(MdbHandle *mdb, char *buf, int *cur_pos, size_t len);
...
/* data.c */
extern LIBMDB_DLL int mdb_bind_column_by_name(MdbTableDef *table, const gchar *col_name, void *bind_ptr, int *len_ptr);
...
extern LIBMDB_DLL int mdb_find_pg_row(MdbHandle *mdb, int pg_row, char **buf, int *off, size_t *len);
...
/* write.c */
extern LIBMDB_DLL void mdb_put_int16(char *buf, guint32 offset, guint32 value);
extern LIBMDB_DLL void mdb_put_int32(char *buf, guint32 offset, guint32 value);
extern LIBMDB_DLL void mdb_put_int32_msb(char *buf, guint32 offset, guint32 value);
